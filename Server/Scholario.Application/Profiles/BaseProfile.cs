...
namespace Scholario.Application.Profiles
{
    public class BaseProfile : Profile
    {
        public BaseProfile()
        {
            ...
            CreateMap<ScheduleEntry, ReadScheduleEntryDto>()
                ...
                .ForMember(dest => dest.ClassroomNumber, x => x.MapFrom(src => src.Classroom.Number))
            ...
            CreateMap<Classroom, ReadClassRoomDto>();
            CreateMap<ReadClassRoomDto, Classroom>();
